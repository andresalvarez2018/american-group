      ...
      <div class="container-fluid">
        ...
        <div>
          <div class="alert alert-success alert-dismissible">
            ...
            Se han cargado <?php echo $_GET['r'] ?> registros exitoso..
          </div>
        </div>
        <?php
        }
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form id="quickForm" enctype="multipart/form-data" method="POST" action="../controladores/base_new.php">
                <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Nombre Completo</label>
                    <input type="text" name="complete_name" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nombre Completo" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Seleccione una campaña</label>
                    <select class="form-control" aria-label="Default select example" name="campana_id" required>
                  ...
                  <div class="form-group">
                    <div class="custom-file">
                      <label for="formFile" class="form-label">Cargar la plantilla base de datos</label>
                      <input class="form-control" type="file" id="formFile" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" name="base_upload" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
              ...
              <div class="card-footer">
                  <a type="submit" class="btn btn-info btn-block" href="../controladores/plantilla_cargue_bases.xlsx">Descargar Plantilla</a>
              </div>
            </div>
            <!-- /.card -->
            </div>
