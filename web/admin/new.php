<?php
    ...
    if ($mysqli -> connect_errno) {
     ...
     // Perform query
     if ($result_user = $mysqli -> query("SELECT * FROM `role`")) {
      ...
      <?php
        ...
        <div>
          <div class="alert alert-danger alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h5><i class="icon fas fa-check"></i> Error Fatal!!</h5>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" enctype="multipart/form-data" method="POST" action="../controladores/user_new.php">
                <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Nombre Completo</label>
                    <input type="text" name="complete_name" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nombre Completo" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Usuario</label>
                    <input type="text" name="user_name" class="form-control" id="exampleInputEmail1" placeholder="Usuario para iniciar sesión" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Contraseña</label>
                    <input type="password" name="password" class="form-control" id="exampleInputEmail1" placeholder="Ingrese la contraseña" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Confirmar Contraseña</label>
                    <input type="password" name="reply_password" class="form-control" id="exampleInputEmail1" placeholder="Confirme la contraseña" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Seleccione un rol</label>
                    <select class="form-control" aria-label="Default select example" name="role_id">
                        <option disabled selected>Abrir este menú de selección</option>
                        <?php 
                            // Perform query
                            if ($result_role = $mysqli -> query("SELECT * FROM `role`")) {
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Seleccione una campaña</label>
                    <select class="form-control" aria-label="Default select example" name="campana_id">
                        <option disabled selected>Abrir este menú de selección</option>
                        <?php 
                            // Perform query
                  ...
                  <div class="form-group">
                    <div class="custom-file">
                      <label for="formFile" class="form-label">Cargar la foto del usuario</label>
