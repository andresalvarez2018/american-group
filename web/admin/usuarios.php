            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                    ...
                    <table id="list_usuarios" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
                        if ($result = $mysqli -> query("SELECT u.id,u.complete_name,r.name as rol,u.is_active,c.name as campana,gj.name as group_name FROM `user` as u inner join role as r on r.id=u.role_id INNER join campana as c on c.id=u.campana_id left join details_group_jobs as dgj on dgj.user_id=u.id left join group_jobs as gj on gj.id=dgj.group_jobs_id")) {
                            while ($reg = $result->fetch_array()) {
                            ?>
                                <tr>
                                    <td><?php echo $reg['complete_name'] ?></td>
                                    <td><?php echo $reg['rol'] ?></td>
                                    <td><?php echo $reg['campana'] ?></td>
                                    <td><?php echo $reg['group_name'] ?></td>
                                    <td>
                                        <?php 
                                            if ($reg['is_active'] == "1") {
                                                echo "Activo";
                                    ...
                                    <td>
                                      ...
                                      ?>
                                        <div class="btn-group btn-expand">
                                            ...
                                            <div class="dropdown-menu " role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(68px, 38px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a class="dropdown-item" href="./editar.php?id=<?php echo $reg['id'] ?>">Editar</a>
                                                <a class="dropdown-item" href="../controladores/desactivar_usuario.php?id=<?php echo $reg['id'] ?>">Desactivar</a>
                                                <a class="dropdown-item" href="../controladores/resturar_contrasena.php?id=<?php echo $reg['id'] ?>">Restaurar Contraseña</a>
                                            </div>
                                        </div>
                                      <?php
                                            }elseif ($reg['is_active'] == "0") {
                                      ?>
                                        <div class="btn-group btn-expand">
                                            ...
                                            <div class="dropdown-menu " role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(68px, 38px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a class="dropdown-item" href="./editar.php?id=<?php echo $reg['id'] ?>">Editar</a>
                                                <a class="dropdown-item" href="../controladores/activar_usuario.php?id=<?php echo $reg['id'] ?>">Activar</a>
                                                <a class="dropdown-item" href="../controladores/resturar_contrasena.php?id=<?php echo $reg['id'] ?>">Restaurar Contraseña</a>
                                            </div>
                                        </div>
                                      <?php
