        ...
        <div class="col-sm-8">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6 ">
                    ...
                    <input type="text" name="identification" class="form-control" id="identification" value="<?php echo $full_name ?>" disabled>
                </div>
                <div class="form-group col-sm-6 ">
            ...
            <div class="timeline">
                ...
                <div>
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header"><a href="#"><?php echo $reg['complete_name'] ?></a> <?php echo $reg['estado'] ?></h3>
